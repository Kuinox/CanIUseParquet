...
def symbol(val):
    """Convert a boolean/None to a matrix symbol."""
    if val is True:
        return "✅"
    elif val is False:
        return "❌"
...
def generate_table(headers, rows, feature_key, results):
...
def generate_markdown(results):
    ...
    lines.append("")
    lines.append("> **Legend:** ✅ = Supported | ❌ = Not supported | ➖ = Not tested / unavailable")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("")
    lines.append(generate_table(["Codec"], COMPRESSION_CODECS, "compression", results))
    lines.append("")
    lines.append("---")
    lines.append("")

    # Encoding
    lines.append("## Encoding Types")
    lines.append("")
    lines.append(generate_table(["Encoding"], ENCODINGS, "encoding", results))
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("")
    lines.append(generate_table(["Logical Type"], LOGICAL_TYPES, "logical_types", results))
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("")
    lines.append(generate_table(["Type"], NESTED_TYPES, "nested_types", results))
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("")
    lines.append(generate_table(["Feature"], ADVANCED_FEATURES, "advanced_features", results))
    lines.append("")
    lines.append("---")
    lines.append("")
